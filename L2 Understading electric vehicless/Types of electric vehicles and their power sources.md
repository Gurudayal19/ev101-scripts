...
**Battery Electric Vehicles (BEVs)**: BEVs are fully powered by electricity stored in high-capacity batteries. They do not have an internal combustion engine and produce zero emissions. These vehicles require charging from external power sources, such as charging stations or home outlets.
...
-=- Source: [U.S. Department of Energy](https://afdc.energy.gov/vehicles/how-do-hybrid-electric-cars-work)
 ...
 PHEVs combine an electric motor with an internal combustion engine. They can operate in all-electric mode for shorter distances using their battery, and then switch to the internal combustion engine when the battery charge is depleted. PHEVs can also be charged externally, increasing their electric-only range compared to traditional hybrids.
...
HEVs are powered by both gasoline and electricity. The electric energy is generated by the car’s own braking system to recharge the battery. This is called **regenerative braking**, a process where electric motor helps to slow the vehicle and captures energy that would otherwise be lost as heat.
...
The amount of energy stored is determined by the size of the hydrogen fuel tank. Unlike BEVs, where energy and power are both related to battery size, FCEVs can adjust energy storage independently.
